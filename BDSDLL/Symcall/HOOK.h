...
constexpr RVA ChangeSettingCommand_setup = 0x000A3B60;
...
constexpr RVA ServerNetworkHandler_handle = 0x003A03A0;
...
constexpr RVA ServerNetworkHandler__getServerPlayer = 0x003AE590;
...
constexpr RVA CommandUtils_displayLocalizableMessage = 0x00445CB0;
...
constexpr RVA CommandRegistry_registerCommand = 0x0042D260;
...
constexpr RVA Actor_getNameTag = 0x00562BC0;
...
constexpr RVA Level_tick = 0x00A75A30;

// [原型] public: void __cdecl Level::forEachPlayer(class std::function<bool __cdecl(class Player & __ptr64)>) __ptr64
